 ...
 * @author allela
 */
public class ArticleAddForm extends SideMenuBaseForm{
    public ArticleAddForm(Resources res) {
        ...
        add(new Label("Add an article", "TodayTitle"));
        
       Vector <String> vectorCat;
       vectorCat = new Vector();
       Vector <String> vectorScat;
       vectorScat = new Vector();
       Vector <String> vectorMarque;
       vectorMarque = new Vector();
       
       ArrayList<Marque> result = new ArrayList<>();
       result = ServiceArticle.getInstance().getMarques();
       for (Marque c : result){
       ...
       ComboBox <String> marque = new ComboBox <> (vectorMarque);
        ...
        //TextField soucat = new TextField("", "Sous Categorie", 20, TextField.USERNAME);
        ...
        addButton.addActionListener(e -> {
            if (Dialog.show("Succes", "The article will be added", "Ok", "Cancel")) {
                ServiceArticle.getInstance().ajouterArticle(new Article(SessionManager.getId(),cat.getSelectedItem(),marque.getSelectedItem(),scat.getSelectedItem(),nom.getText(),etat.getText(),desc.getText()));
