 ...
 * @author idriss
 */
public class ProduitAddForm extends SideMenuBaseForm {

    public ProduitAddForm(Resources res) {
        ...
        TextField titre = new TextField("", "Title", 20, TextField.USERNAME);
        TextField prix = new TextField("", "Price", 20, TextField.USERNAME);

        Button addButton = new Button("ADD");
        addButton.addActionListener(e -> {
            if (Dialog.show("Succes", "The produit will be added", "Ok", "Cancel")) {
                ServiceProduit.getInstance().ajouterProduit(new Produit(Integer.parseInt(boutique.getSelectedItem()), titre.getText(), Float.parseFloat(prix.getText()), image.getText()));
