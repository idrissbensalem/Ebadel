 ...
 * Produit
 *
 * @ORM\Table(name="produit", indexes={@ORM\Index(name="nom_m", columns={"nom_m"}), @ORM\Index(name="nom_s_c", columns={"nom_s_c"}), @ORM\Index(name="nom_c", columns={"nom_c", "nom_s_c", "nom_m"}), @ORM\Index(name="IDX_29A5EC272AF2F06E", columns={"nom_c"})})
 * @ORM\Entity
 */
class Produit
{
